...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        d3.select("#" + leftPanelID).append("text")
            ...
            .text("Distribuição Marginal do Tópico");
        d3.select("#" + leftPanelID).append("text")
            .attr("x", cx2 + 10)
        ...
        svg.append("text")
            .text("Mapa de Distância entre Tópicos")
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .text("Frequência geral do termo");
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("Frequência do termo estimada dentro do tópico selecionado");
        ...
        d3.select("#" + barFreqsID)
            ...
            .style("dominant-baseline", "middle")
            .text("1. saliency(term w) = frequency(w) * [sum_t p(t | w) * log(p(t | w)/p(t))] para tópicos t; veja Chuang et. al (2012)");
        d3.select("#" + barFreqsID)
            .append("a")
            ...
            .style("dominant-baseline", "middle")
            .text("2. relevance(term w | topic t) = \u03BB * p(w | t) + (1 - \u03BB) * p(w | t)/p(w); veja Sievert & Shirley (2014)");
        ...
        var title = chart.append("text")
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Termos Mais Relevantes");
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.innerHTML = "Tópico Selecionado: <span id='" + topicID + "-value'></span>";
            ...
            var xx = d3.select("#" + lambdaZeroID)
                    ...
                    .text("Slider para Ajuste da Relevância: \n");
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Termos mais Relevantes para o Tópico " + topics + " (" + Freq + "% dos termos)");
        ...
        function term_on(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("Distribuição condicional de tópicos dado o termo = '" + term.innerHTML + "'");
        }
        ...
        function term_off(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("Distribuição marginal de tópicos");
